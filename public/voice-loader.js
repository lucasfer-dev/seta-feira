(async () => {
  try {
    ...
    document.documentElement.dataset.voiceCore = 'v10-smart-barge';
    console.info('[SEXTA] Voice Core v10 + Smart Barge-In carregados.');
  } catch (error) {
    console.error('[SEXTA] Voice Core v10 falhou.', error);
    document.documentElement.dataset.voiceCore = 'v10-smart-barge-error';
