...
export async function getLiveToolDeclarations() {
  ...
  const seen = new Set();
  return [...LIVE_TOOL_DECLARATIONS, ...ANDROID_HANDS_TOOL_DECLARATIONS, ...PC_DESKTOP_TOOL_DECLARATIONS, ...V4_TOOL_DECLARATIONS, CAPABILITY_DISPATCH_DECLARATION, ...mcp].filter(tool => {
